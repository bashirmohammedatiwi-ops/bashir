...
export function PhoneCanvas({
  ...
  return (
    <div className="hb-canvas-wrap">
      <div className="hb-canvas-device">
        {/* Status bar */}
        ...
        {/* App header mock — Nice One style */}
        ...
        <div className="hb-canvas-scroll">
          {sorted.length === 0 ? (
            <div className="hb-canvas-empty">
              <Empty description="الصفحة فارغة" />
      ...
      <p className="hb-canvas-hint">انقر أي قسم للتعديل · اسحب ≡ للترتيب · + لإضافة قسم</p>
    </div>
  );
}
