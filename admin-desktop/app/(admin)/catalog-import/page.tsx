  ...
  return (
    <div className="catalog-import-page">
      <PageHeader
        ...
        subtitle={`البحث في Nice One · Vanilla · الريان · ميرايا · وجوه · Amazon — ${CATALOG_HUB_URL}`}
      />
      ...
      <section className="catalog-import-toolbar">
        <div className="catalog-import-toolbar-text">
          ...
          <p>ابحث في Nice One · Vanilla · الريان · ميرايا · وجوه · Amazon — تظهر النتائج أفقياً مع الصور والتدرجات</p>
        </div>
