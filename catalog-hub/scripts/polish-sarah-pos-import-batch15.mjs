...
const PRODUCTS = new URL('../data/sarah-pos-import-products-batch15.json', import.meta.url).pathname;
const CANDIDATES = new URL('../data/sarah-pos-candidates-batch15.json', import.meta.url).pathname;
...
const DESC_AR = JSON.parse(readFileSync(new URL('../data/sarah-pos-batch15-desc-ar.json', import.meta.url), 'utf8'));
...
console.log(`Polished ${products.length} batch15 products`);
