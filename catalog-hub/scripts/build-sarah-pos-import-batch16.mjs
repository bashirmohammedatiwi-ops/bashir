...
const SELECTED = Object.keys(JSON.parse(readFileSync(new URL('../data/sarah-pos-batch16-meta.json', import.meta.url), 'utf8')));
...
writeFileSync(new URL('../data/sarah-pos-import-products-batch16.json', import.meta.url).pathname, `${JSON.stringify(selected, null, 2)}\n`);
console.log(`Built batch16: ${selected.length} products`);
