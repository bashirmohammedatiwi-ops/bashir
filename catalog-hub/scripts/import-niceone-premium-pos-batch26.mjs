#!/usr/bin/env node
/**
 * استيراد 50 منتج بريميوم إضافي من نايس وان (batch26):
 ...
 *   LIMIT=50 MIN_POS_STOCK=0 ALLOW_NO_POS=1 node scripts/import-niceone-premium-pos-batch26.mjs
 */
...
const STATE_FILE = path.join(__dirname, '../data/niceone-premium-pos-batch26-state.json');
const CANDIDATES_FILE = path.join(__dirname, '../data/niceone-premium-pos-batch26-candidates.json');
...
async function main() {
  ...
  console.log(`Nice One PREMIUM import batch26`);
