...
const CAND_FILE = process.env.CANDIDATES_FILE || '../data/sarah-pos-candidates-care-batch17.json';
...
const SELECTED = Object.keys(JSON.parse(readFileSync(new URL('../data/sarah-pos-batch17-meta.json', import.meta.url), 'utf8')));
...
writeFileSync(new URL('../data/sarah-pos-import-products-batch17.json', import.meta.url).pathname, `${JSON.stringify(selected, null, 2)}\n`);
console.log(`Built batch17: ${selected.length} products`);
