...
const PRODUCTS = JSON.parse(readFileSync(new URL('../data/sarah-pos-import-products-batch18.json', import.meta.url), 'utf8'));
...
writeFileSync(new URL('../data/sarah-pos-import-products-batch18.json', import.meta.url).pathname, `${JSON.stringify(PRODUCTS, null, 2)}\n`);
