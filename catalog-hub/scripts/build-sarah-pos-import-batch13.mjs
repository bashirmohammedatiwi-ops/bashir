...
const candidates = JSON.parse(readFileSync(new URL('../data/sarah-pos-candidates-batch13.json', import.meta.url), 'utf8'));
...
const SELECTED = Object.keys(JSON.parse(readFileSync(new URL('../data/sarah-pos-batch13-meta.json', import.meta.url), 'utf8')));
...
writeFileSync(new URL('../data/sarah-pos-import-products-batch13.json', import.meta.url).pathname, `${JSON.stringify(selected, null, 2)}\n`);
console.log(`Built batch13: ${selected.length} products`);
