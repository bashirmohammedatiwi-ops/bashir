...
const OUT = new URL('../data/sarah-pos-batch14-meta.json', import.meta.url).pathname;
const ORDER_OUT = new URL('../data/sarah-pos-batch14-order.json', import.meta.url).pathname;
...
writeFileSync(new URL('../data/sarah-pos-batch14-desc-ar.json', import.meta.url).pathname, '{}\n');
