...
const OUT = new URL('../data/sarah-pos-batch13-meta.json', import.meta.url).pathname;
const ORDER_OUT = new URL('../data/sarah-pos-batch13-order.json', import.meta.url).pathname;
...
writeFileSync(new URL('../data/sarah-pos-batch13-desc-ar.json', import.meta.url).pathname, '{}\n');
