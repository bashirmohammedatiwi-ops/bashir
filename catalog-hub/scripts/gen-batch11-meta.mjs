...
const OUT = new URL('../data/sarah-pos-batch11-meta.json', import.meta.url).pathname;
const ORDER_OUT = new URL('../data/sarah-pos-batch11-order.json', import.meta.url).pathname;
...
writeFileSync(new URL('../data/sarah-pos-batch11-desc-ar.json', import.meta.url).pathname, '{}\n');
