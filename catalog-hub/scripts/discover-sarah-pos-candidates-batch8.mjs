#!/usr/bin/env node
/** Discover batch-8 Sarah+POS candidates (excludes batches 1-7). */
...
const OUT = new URL('../data/sarah-pos-candidates-batch8.json', import.meta.url).pathname;
...
const client = createSallaClient(process.env.SALLA_STORE || 'sarahmakeup37.com', { cachePrefix: `sarah-discover-b8-${Date.now()}` });
...
async function main() {
  ...
  const queries = [
    'Montale', 'Mancera', 'Initio', 'Amouage', 'Byredo', 'Parfums de Marly', 'Memo Paris', 'Le Labo',
    'Bath and Body Works', 'Victoria Secret', 'Sol de Janeiro', 'Moroccanoil', 'Olaplex', 'Kerastase',
    'Redken', 'Schwarzkopf', 'Wella', 'MAC', 'Benefit', 'NARS', 'Urban Decay', 'Charlotte Tilbury',
    'Fenty', 'Filorga', 'Isdin', 'Avene', 'Uriage', 'Biore', 'Simple', 'Pantene', 'OGX', 'Batiste',
    'Davidoff', 'Jaguar', 'Afnan', 'Lattafa', 'Rasasi', 'Ajmal', 'Swiss Arabian', 'Tom Ford', 'Tiffany',
    'Mugler', 'Burberry', 'Chanel', 'Montblanc', 'Color Wow', 'Flormar', 'Skin1004', 'Cosrx', 'Anua',
    'Torriden', 'Laneige', 'Innisfree', 'Armaf', 'Ralph Lauren', 'Guess', 'Coach', 'Escada', 'Zadig',
    'Swiss Image', 'Solgar', 'Kiko', 'Essence', 'Rare Beauty', 'Huda Beauty', 'Guerlain', 'Kenzo',
    'Clarins', 'Shiseido', 'Bioderma', 'Eucerin', 'La Roche', 'Garnier', 'Tresemme', 'Head Shoulders',
