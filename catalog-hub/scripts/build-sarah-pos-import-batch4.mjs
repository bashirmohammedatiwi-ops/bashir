...
const candidates = JSON.parse(readFileSync(new URL('../data/sarah-pos-candidates-batch4.json', import.meta.url), 'utf8'));
...
writeFileSync(new URL('../data/sarah-pos-import-products-batch4.json', import.meta.url).pathname, `${JSON.stringify(selected, null, 2)}\n`);
console.log(`Built batch4: ${selected.length} products`);
