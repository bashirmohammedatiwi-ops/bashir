...
const candidates = JSON.parse(readFileSync(new URL('../data/sarah-pos-candidates-batch9.json', import.meta.url), 'utf8'));
...
const SELECTED = Object.keys(JSON.parse(readFileSync(new URL('../data/sarah-pos-batch9-meta.json', import.meta.url), 'utf8')));
...
writeFileSync(new URL('../data/sarah-pos-import-products-batch9.json', import.meta.url).pathname, `${JSON.stringify(selected, null, 2)}\n`);
console.log(`Built batch9: ${selected.length} products`);
