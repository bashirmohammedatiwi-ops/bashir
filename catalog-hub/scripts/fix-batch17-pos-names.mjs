#!/usr/bin/env node
/** Fix batch17 meta names from POS when Sarah metadata is missing. */
import { readFileSync, writeFileSync } from 'fs';

const META_PATH = new URL('../data/sarah-pos-batch17-meta.json', import.meta.url).pathname;
const CAND_PATH = new URL('../data/sarah-pos-candidates-care-batch17.json', import.meta.url).pathname;
