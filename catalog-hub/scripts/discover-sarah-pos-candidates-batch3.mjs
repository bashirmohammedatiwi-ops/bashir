#!/usr/bin/env node
/** Discover batch-3 Sarah+POS candidates (excludes batches 1+2). */
...
const OUT = new URL('../data/sarah-pos-candidates-batch3.json', import.meta.url).pathname;
...
const client = createSallaClient(process.env.SALLA_STORE || 'sarahmakeup37.com', { cachePrefix: 'sarah-discover-b3' });
...
async function main() {
  ...
  const queries = [
    'Tom Ford', 'YSL', 'Armani', 'Dior', 'Givenchy', 'Montblanc', 'Burberry', 'Davidoff',
    'Jaguar', 'Hugo Boss', 'Calvin Klein', 'David Beckham', 'Lancome', 'Lancome', 'Biotherm',
    'Clinique', 'Estee Lauder', 'MAC', 'NYX', 'Loreal', 'Garnier', 'Nivea', 'The Ordinary',
    'CeraVe', 'Cosrx', 'Anua', 'Laneige', 'Rabanne', 'JPG', 'Initio', 'Xerjoff', 'Amouage',
    'Lattafa', 'Rasasi', 'Ajmal', 'Swiss Arabian', 'Al Haramain', 'Maison', 'Byredo',
    'عطر رجالي', 'عطر نسائي', 'كريم', 'سيروم', 'شامبو', 'مكياج', 'ماسكارا', 'بودرة',
  ];
