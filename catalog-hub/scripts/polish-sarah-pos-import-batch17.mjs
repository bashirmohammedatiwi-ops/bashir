...
const PRODUCTS = new URL('../data/sarah-pos-import-products-batch17.json', import.meta.url).pathname;
const CANDIDATES = new URL(process.env.CANDIDATES_FILE || '../data/sarah-pos-candidates-care-batch17.json', import.meta.url).pathname;
...
const DESC_AR = JSON.parse(readFileSync(new URL('../data/sarah-pos-batch17-desc-ar.json', import.meta.url), 'utf8'));
...
console.log(`Polished ${products.length} batch17 products`);
