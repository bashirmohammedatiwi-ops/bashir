#!/usr/bin/env node
/** Discover batch-7 Sarah+POS candidates (excludes batches 1-6). */
...
const client = createSallaClient(process.env.SALLA_STORE || 'sarahmakeup37.com', { cachePrefix: `sarah-discover-b7-${Date.now()}` });
