#!/usr/bin/env node
/** Discover batch-3 Sarah+POS candidates (excludes batches 1-4). */
...
const OUT = new URL('../data/sarah-pos-candidates-batch5.json', import.meta.url).pathname;
...
const client = createSallaClient(process.env.SALLA_STORE || 'sarahmakeup37.com', { cachePrefix: 'sarah-discover-b5' });
