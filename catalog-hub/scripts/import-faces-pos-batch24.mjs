 ...
 *
 * Usage:
 *   LIMIT=50 MIN_POS_STOCK=2 node scripts/import-faces-pos-batch24.mjs
 *   SCAN_ONLY=1 node scripts/import-faces-pos-batch24.mjs
 */
...
const STATE_FILE = path.join(__dirname, '../data/faces-pos-batch24-state.json');
const CANDIDATES_FILE = path.join(__dirname, '../data/faces-pos-batch24-candidates.json');
...
async function main() {
  ...
  console.log(`FACES import batch24`);
