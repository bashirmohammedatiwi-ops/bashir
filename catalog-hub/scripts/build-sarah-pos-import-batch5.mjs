...
/** Manual verified metadata for all batch-4 products */
const META = JSON.parse(readFileSync(new URL('../data/sarah-pos-batch5-meta.json', import.meta.url), 'utf8'));
...
writeFileSync(new URL('../data/sarah-pos-import-products-batch5.json', import.meta.url).pathname, `${JSON.stringify(selected, null, 2)}\n`);
console.log(`Built batch5: ${selected.length} products`);
