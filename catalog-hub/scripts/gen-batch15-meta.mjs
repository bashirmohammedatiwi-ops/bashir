...
const OUT = new URL('../data/sarah-pos-batch15-meta.json', import.meta.url).pathname;
const ORDER_OUT = new URL('../data/sarah-pos-batch15-order.json', import.meta.url).pathname;
...
writeFileSync(new URL('../data/sarah-pos-batch15-desc-ar.json', import.meta.url).pathname, '{}\n');
