...
const cands = JSON.parse(readFileSync(new URL('../data/sarah-pos-candidates-batch8.json', import.meta.url), 'utf8'));
...
writeFileSync(new URL('../data/sarah-pos-batch8-meta.json', import.meta.url).pathname, `${JSON.stringify(meta, null, 2)}\n`);
let bad = 0;
