...
const PRODUCTS = new URL('../data/sarah-pos-import-products-batch8.json', import.meta.url).pathname;
const CANDIDATES = new URL('../data/sarah-pos-candidates-batch8.json', import.meta.url).pathname;
...
const DESC_AR = JSON.parse(readFileSync(new URL('../data/sarah-pos-batch8-desc-ar.json', import.meta.url), 'utf8'));
...
console.log(`Polished ${products.length} batch8 products`);
