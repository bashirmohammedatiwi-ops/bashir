#!/usr/bin/env node
/** Polish batch-7 — verified EN names, Sarah AR names, bilingual descriptions. */
import { readFileSync, writeFileSync } from 'fs';
import { CATEGORIES } from '../lib/core/app-categories.js';

const PRODUCTS = new URL('../data/sarah-pos-import-products-batch7.json', import.meta.url).pathname;
const CANDIDATES = new URL('../data/sarah-pos-candidates-batch7.json', import.meta.url).pathname;
...
const DESC_AR = JSON.parse(readFileSync(new URL('../data/sarah-pos-batch7-desc-ar.json', import.meta.url), 'utf8'));
...
console.log(`Polished ${products.length} batch7 products`);
