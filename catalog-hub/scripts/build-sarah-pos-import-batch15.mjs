...
const SKIP = new Set([
  ...
  '7640233342909', '3439600056976', '3349668111367', '3614273926904', '3423478901285',
]);
...
const candidates = JSON.parse(readFileSync(new URL('../data/sarah-pos-candidates-batch15.json', import.meta.url), 'utf8'));
...
const SELECTED = Object.keys(JSON.parse(readFileSync(new URL('../data/sarah-pos-batch15-meta.json', import.meta.url), 'utf8')));
...
writeFileSync(new URL('../data/sarah-pos-import-products-batch15.json', import.meta.url).pathname, `${JSON.stringify(selected, null, 2)}\n`);
console.log(`Built batch15: ${selected.length} products`);
