/**
 * Elixir Contour & Highlight Palette Golden Touch 844B — single SKU.
 * Sources: elixirmakeup.gr + pellapharmacy.gr (barcode, price, description)
 * Usage: npx tsx scripts/add-elixir-contour-highlight-palette-golden-touch-api.ts
 */
...
const PRODUCT = {
  barcode: "5206929505328",
  slug: "elixir-contour-highlight-palette-golden-touch-844b",
  sku: "ELX-CHP-844B",
  price: 14900,
  nameAr: "إليكسير - باليت كونتور وهايلايتر Golden Touch 844B",
  nameEn: "Elixir - Contour & Highlight Palette Golden Touch 844B",
  descriptionAr:
    "باليت كونتور وهايلايتر Golden Touch من إليكسير — لتشكيل الوجه وإضافة لمعان ذهبي دافئ.\n\n" +
    "• 4 درجات كونتور لتحديد ونحت ملامح الوجه.\n• 4 درجات هايلايتر للإشراق على الخدود والأنف والجبين.\n• تركيبة سهلة الدمج بدرجات ذهبية دافئة.\n• مثالية للمكياج اليومي والاحترافي.\n• صُنع في أوروبا.",
  descriptionEn:
    "Elixir Contour & Highlight Palette Golden Touch 844B — sculpt and illuminate with warm golden glow.\n\n" +
    "• 4 contour shades to define and add depth to facial structure.\n• 4 highlighter shades for glow on cheekbones, nose and brow bone.\n• Easy-to-blend formula with warm golden tones.\n• Ideal for everyday and professional makeup.\n• Made in Europe.",
  imageUrls: [
    "https://elixirmakeup.gr/wp-content/uploads/2022/09/844B_open-1024x1024.jpg",
    "https://elixirmakeup.gr/wp-content/uploads/2022/09/844B_close-1024x1024.jpg",
  ],
};
