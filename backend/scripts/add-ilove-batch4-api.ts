/**
 * إضافة الدفعة الرابعة من منتجات ilove (Hand & Nail Cream) عبر API — بدون صور.
 * Usage: API_BASE=https://deemaalhayat.com/api/v1 ADMIN_PASSWORD=000000 npx tsx scripts/add-ilove-batch4-api.ts
 */
