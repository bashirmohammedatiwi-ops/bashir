const searchUrl = "https://radiant-professional.com/en/search/?q=matt+lasting+lip+color";
const searchHtml = await (await fetch(searchUrl, { headers: { "User-Agent": "Mozilla/5.0" } })).text();
const catalogueMatch = searchHtml.match(/\/en\/catalogue\/matt-lasting-lip-color_\d+\//i);
if (!catalogueMatch) {
