/**
 * Fix Deborah mascara batch — 6 separate single-SKU products (no shades).
 * Deletes existing entries by barcode and recreates without shade rows.
 * Usage: npx tsx scripts/fix-deborah-mascara-batch-6-single-api.ts
 */
